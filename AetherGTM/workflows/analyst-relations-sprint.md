# Analyst Relations Sprint

**Trigger:** `/analyst-relations-sprint`  
**Type:** workflow  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Run the end-to-end Analyst Relations Sprint GTM motion.
...
```json
{
  "workflow": "/analyst-relations-sprint",
  "version": "1.0.0",
  "goal": "",
  "success_metrics": [],
  "diagnosis": [],
