...
**Trigger:** `/partner-scorecard`  
**Domain:** partnerships  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create partner scorecard and tiering model.
...
## Task
Create partner scorecard and tiering model.
...
## Examples
**Input:** `Run /partner-scorecard for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /partner-scorecard using our current CRM funnel and last 90 days of win/loss notes.`  
