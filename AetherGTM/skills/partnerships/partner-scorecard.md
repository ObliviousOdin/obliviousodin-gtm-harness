...
## Task
Create partner scorecard and tiering model. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /partner-scorecard for enterprise fintech accounts in North America; output=hybrid.`
