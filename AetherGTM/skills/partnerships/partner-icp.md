...
## Task
Define partner ICP. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /partner-icp for mid-market SaaS security buyers.`
