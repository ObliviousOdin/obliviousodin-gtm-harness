...
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Draft marketplace listing copy and conversion plan.
...
## Task
Draft marketplace listing copy and conversion plan.
...
## Examples
**Input:** `Run /marketplace-listing for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /marketplace-listing using our current CRM funnel and last 90 days of win/loss notes.`  
