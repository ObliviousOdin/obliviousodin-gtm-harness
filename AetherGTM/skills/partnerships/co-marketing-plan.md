...
**Trigger:** `/co-marketing-plan`  
**Domain:** partnerships  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create co-marketing plan.
...
## Examples
**Input:** `Run /co-marketing-plan for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /co-marketing-plan using our current CRM funnel and last 90 days of win/loss notes.`  
