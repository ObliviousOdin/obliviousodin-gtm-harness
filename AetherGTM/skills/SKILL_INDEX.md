...
| --- | --- | --- |
| [Board Metrics](./analytics/board-metrics.md) | `/board-metrics` | 1.0.0 |
| [Cohort Analysis](./analytics/cohort-analysis.md) | `/cohort-analysis` | 1.0.0 |
...
| Skill | Trigger | Version |
| --- | --- | --- |
| [Assumption Ledger](./core/assumption-ledger.md) | `/assumption-ledger` | 1.0.0 |
| [Context Loader](./core/context-loader.md) | `/load-gtm-context` | 1.0.0 |
| [Decision Memo](./core/decision-memo.md) | `/decision-memo` | 1.0.0 |
| [Experiment Designer](./core/experiment-designer.md) | `/experiment-design` | 1.0.0 |
| [Gtm Audit](./core/gtm-audit.md) | `/gtm-audit` | 1.0.0 |
...
| Skill | Trigger | Version |
| --- | --- | --- |
| [Adoption Play](./customer-success/adoption-play.md) | `/adoption-play` | 1.0.0 |
| [Churn Postmortem](./customer-success/churn-postmortem.md) | `/churn-postmortem` | 1.0.0 |
| [Expansion Play](./customer-success/expansion-play.md) | `/expansion-play` | 1.0.0 |
...
| Skill | Trigger | Version |
| --- | --- | --- |
| [Abm Play](./demand-gen/abm-play.md) | `/abm-play` | 1.0.0 |
| [Campaign Brief](./demand-gen/campaign-brief.md) | `/campaign-brief` | 1.0.0 |
| [Content Cluster](./demand-gen/content-cluster.md) | `/content-cluster` | 1.0.0 |
| [Event Field Plan](./demand-gen/event-field-plan.md) | `/event-field-plan` | 1.0.0 |
| [Intent Data Play](./demand-gen/intent-data-play.md) | `/intent-data-play` | 1.0.0 |
| [Landing Page](./demand-gen/landing-page.md) | `/landing-page` | 1.0.0 |
...
| Skill | Trigger | Version |
| --- | --- | --- |
| [Battlecard Builder](./enablement/battlecard-builder.md) | `/battlecard-builder` | 1.0.0 |
...
| Skill | Trigger | Version |
| --- | --- | --- |
| [Co Marketing Plan](./partnerships/co-marketing-plan.md) | `/co-marketing-plan` | 1.0.0 |
| [Integration Launch](./partnerships/integration-launch.md) | `/integration-launch` | 1.0.0 |
...
| Skill | Trigger | Version |
| --- | --- | --- |
| [Analyst Briefing](./pm-m/analyst-briefing.md) | `/analyst-briefing` | 1.0.0 |
| [Category Narrative](./pm-m/category-narrative.md) | `/category-narrative` | 1.0.0 |
| [Customer Story Brief](./pm-m/customer-story-brief.md) | `/customer-story-brief` | 1.0.0 |
| [Launch Brief](./pm-m/launch-brief.md) | `/launch-brief` | 1.0.0 |
| [Message House](./pm-m/message-house.md) | `/message-house` | 1.0.0 |
...
| Skill | Trigger | Version |
| --- | --- | --- |
| [Discount Governance](./pricing-packaging/discount-governance.md) | `/discount-governance` | 1.0.0 |
...
| Skill | Trigger | Version |
| --- | --- | --- |
| [Attribution Review](./revops/attribution-review.md) | `/attribution-review` | 1.0.0 |
| [Capacity Model](./revops/capacity-model.md) | `/capacity-model` | 1.0.0 |
| [Forecast Narrative](./revops/forecast-narrative.md) | `/forecast-narrative` | 1.0.0 |
...
| Skill | Trigger | Version |
| --- | --- | --- |
| [Account Plan](./sales-sdr-ae/account-plan.md) | `/account-plan` | 1.0.0 |
| [Deal Review](./sales-sdr-ae/deal-review.md) | `/deal-review` | 1.0.0 |
| [Demo Plan](./sales-sdr-ae/demo-plan.md) | `/demo-plan` | 1.0.0 |
| [Discovery Guide](./sales-sdr-ae/discovery-guide.md) | `/discovery-guide` | 1.0.0 |
| [Meddic Review](./sales-sdr-ae/meddic-review.md) | `/meddic-review` | 1.0.0 |
| [Mutual Action Plan](./sales-sdr-ae/mutual-action-plan.md) | `/map-create` | 1.0.0 |
