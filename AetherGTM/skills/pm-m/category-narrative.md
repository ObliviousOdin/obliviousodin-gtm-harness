...
## Task
Create a category narrative and point-of-view for market education. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /category-narrative for enterprise fintech accounts in North America; output=hybrid.`
