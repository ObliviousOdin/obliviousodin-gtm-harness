...
**Trigger:** `/category-narrative`  
**Domain:** pm-m  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create a category narrative and point-of-view for market education.
...
## Task
Create a category narrative and point-of-view for market education.
...
## Examples
**Input:** `Run /category-narrative for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /category-narrative using our current CRM funnel and last 90 days of win/loss notes.`  
