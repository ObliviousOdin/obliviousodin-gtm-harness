...
## Task
Create a customer story brief with narrative arc, metrics, and approvals. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /customer-story-brief for enterprise fintech accounts in North America; output=hybrid.`
