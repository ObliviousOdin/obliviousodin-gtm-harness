...
**Trigger:** `/customer-story-brief`  
**Domain:** pm-m  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create a customer story brief with narrative arc, metrics, and approvals.
...
## Task
Create a customer story brief with narrative arc, metrics, and approvals.
...
## Examples
**Input:** `Run /customer-story-brief for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /customer-story-brief using our current CRM funnel and last 90 days of win/loss notes.`  
