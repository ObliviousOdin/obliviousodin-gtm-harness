...
**Trigger:** `/analyst-briefing`  
**Domain:** pm-m  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Prepare an analyst briefing narrative, agenda, and proof package.
...
## Task
Prepare an analyst briefing narrative, agenda, and proof package.
...
## Examples
**Input:** `Run /analyst-briefing for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /analyst-briefing using our current CRM funnel and last 90 days of win/loss notes.`  
