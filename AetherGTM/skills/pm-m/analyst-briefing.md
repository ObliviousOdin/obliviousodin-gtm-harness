...
## Task
Prepare an analyst briefing narrative, agenda, and proof package. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /analyst-briefing for enterprise fintech accounts in North America; output=hybrid.`
