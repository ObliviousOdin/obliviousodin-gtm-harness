...
**Trigger:** `/value-prop-ladder`  
**Domain:** pm-m  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Build value proposition ladders from features to business outcomes.
...
## Task
Build value proposition ladders from features to business outcomes.
...
## Examples
**Input:** `Run /value-prop-ladder for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /value-prop-ladder using our current CRM funnel and last 90 days of win/loss notes.`  
