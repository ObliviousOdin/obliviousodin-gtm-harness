...
## Task
Build value proposition ladders from features to business outcomes. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /value-prop-ladder for enterprise fintech accounts in North America; output=hybrid.`
