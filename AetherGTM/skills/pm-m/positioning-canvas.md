...
**Trigger:** `/positioning-canvas`  
**Domain:** pm-m  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create a differentiated positioning canvas.
...
## Task
Create a differentiated positioning canvas.
...
## Examples
**Input:** `Run /positioning-canvas for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /positioning-canvas using our current CRM funnel and last 90 days of win/loss notes.`  
