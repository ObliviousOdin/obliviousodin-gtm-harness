...
## Task
Build a message house with pillars and proof. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /message-house for mid-market SaaS security buyers.`
