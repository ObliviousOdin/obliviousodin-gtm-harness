...
**Trigger:** `/message-house`  
**Domain:** pm-m  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Build a message house with pillars and proof.
...
## Task
Build a message house with pillars and proof.
...
## Examples
**Input:** `Run /message-house for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /message-house using our current CRM funnel and last 90 days of win/loss notes.`  
