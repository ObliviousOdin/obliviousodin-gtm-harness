...
**Trigger:** `/persona-pain-map`  
**Domain:** pm-m  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Map personas to pains and messages.
...
## Task
Map personas to pains and messages.
...
## Examples
**Input:** `Run /persona-pain-map for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /persona-pain-map using our current CRM funnel and last 90 days of win/loss notes.`  
