...
## Task
Map personas to pains and messages. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /persona-pain-map for mid-market SaaS security buyers.`
