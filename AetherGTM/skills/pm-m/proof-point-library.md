...
**Trigger:** `/proof-point-library`  
**Domain:** pm-m  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create a claim and proof-point library for messaging governance.
...
## Task
Create a claim and proof-point library for messaging governance.
...
## Examples
**Input:** `Run /proof-point-library for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /proof-point-library using our current CRM funnel and last 90 days of win/loss notes.`  
