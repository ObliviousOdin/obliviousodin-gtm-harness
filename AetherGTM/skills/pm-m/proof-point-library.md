...
## Task
Create a claim and proof-point library for messaging governance. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /proof-point-library for enterprise fintech accounts in North America; output=hybrid.`
