...
**Trigger:** `/launch-brief`  
**Domain:** pm-m  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create a launch brief.
...
## Examples
**Input:** `Run /launch-brief for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /launch-brief using our current CRM funnel and last 90 days of win/loss notes.`  
