...
## Task
Create a launch brief. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /launch-brief for mid-market SaaS security buyers.`
