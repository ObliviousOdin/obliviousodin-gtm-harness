...
## Task
Create a high-converting lead magnet concept, outline, and promotion plan. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /lead-magnet for enterprise fintech accounts in North America; output=hybrid.`
