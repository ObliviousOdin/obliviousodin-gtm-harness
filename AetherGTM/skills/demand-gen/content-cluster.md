...
## Task
Design an SEO/content topic cluster. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /content-cluster for mid-market SaaS security buyers.`
