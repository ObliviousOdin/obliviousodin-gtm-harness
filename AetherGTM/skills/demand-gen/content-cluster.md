...
**Trigger:** `/content-cluster`  
**Domain:** demand-gen  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Design an SEO/content topic cluster.
...
## Task
Design an SEO/content topic cluster.
...
## Examples
**Input:** `Run /content-cluster for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /content-cluster using our current CRM funnel and last 90 days of win/loss notes.`  
