...
**Trigger:** `/webinar-engine`  
**Domain:** demand-gen  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Design a webinar program from topic to follow-up conversion path.
...
## Task
Design a webinar program from topic to follow-up conversion path.
...
## Examples
**Input:** `Run /webinar-engine for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /webinar-engine using our current CRM funnel and last 90 days of win/loss notes.`  
