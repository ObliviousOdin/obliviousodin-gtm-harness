...
## Task
Design a webinar program from topic to follow-up conversion path. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /webinar-engine for enterprise fintech accounts in North America; output=hybrid.`
