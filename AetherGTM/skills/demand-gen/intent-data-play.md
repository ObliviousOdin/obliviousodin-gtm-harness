...
## Task
Convert intent data into account selection and coordinated plays. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /intent-data-play for enterprise fintech accounts in North America; output=hybrid.`
