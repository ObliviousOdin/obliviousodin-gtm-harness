...
**Trigger:** `/intent-data-play`  
**Domain:** demand-gen  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Convert intent data into account selection and coordinated plays.
...
## Task
Convert intent data into account selection and coordinated plays.
...
## Examples
**Input:** `Run /intent-data-play for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /intent-data-play using our current CRM funnel and last 90 days of win/loss notes.`  
