...
**Trigger:** `/nurture-architecture`  
**Domain:** demand-gen  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Design nurture streams by persona, stage, trigger, and intent.
...
## Task
Design nurture streams by persona, stage, trigger, and intent.
...
## Examples
**Input:** `Run /nurture-architecture for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /nurture-architecture using our current CRM funnel and last 90 days of win/loss notes.`  
