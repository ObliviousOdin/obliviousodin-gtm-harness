...
## Task
Build an event and field marketing plan with pre/during/post plays. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /event-field-plan for enterprise fintech accounts in North America; output=hybrid.`
