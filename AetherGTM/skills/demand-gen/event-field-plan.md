...
**Trigger:** `/event-field-plan`  
**Domain:** demand-gen  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Build an event and field marketing plan with pre/during/post plays.
...
## Task
Build an event and field marketing plan with pre/during/post plays.
...
## Examples
**Input:** `Run /event-field-plan for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /event-field-plan using our current CRM funnel and last 90 days of win/loss notes.`  
