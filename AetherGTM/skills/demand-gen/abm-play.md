...
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Build an account-based marketing play.
...
## Task
Build an account-based marketing play.
...
## Examples
**Input:** `Run /abm-play for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /abm-play using our current CRM funnel and last 90 days of win/loss notes.`  
