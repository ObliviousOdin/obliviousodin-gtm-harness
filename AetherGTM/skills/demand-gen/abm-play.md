...
## Task
Build an account-based marketing play. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /abm-play for mid-market SaaS security buyers.`
