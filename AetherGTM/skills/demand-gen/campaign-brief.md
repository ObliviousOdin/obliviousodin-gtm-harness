...
## Task
Create a campaign strategy brief. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /campaign-brief for mid-market SaaS security buyers.`
