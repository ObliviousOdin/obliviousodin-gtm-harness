...
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create a campaign strategy brief.
...
## Task
Create a campaign strategy brief.
...
## Examples
**Input:** `Run /campaign-brief for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /campaign-brief using our current CRM funnel and last 90 days of win/loss notes.`  
