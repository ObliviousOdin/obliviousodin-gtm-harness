...
## Examples
**Input:** `Run /landing-page for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /landing-page using our current CRM funnel and last 90 days of win/loss notes.`  
