...
## Task
Design territories using TAM, capacity, coverage, and fairness constraints. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /territory-design for enterprise fintech accounts in North America; output=hybrid.`
