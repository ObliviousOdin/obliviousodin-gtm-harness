...
## Task
Create forecast narrative. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /forecast-narrative for mid-market SaaS security buyers.`
