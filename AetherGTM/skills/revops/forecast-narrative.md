...
**Trigger:** `/forecast-narrative`  
**Domain:** revops  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create forecast narrative.
...
## Examples
**Input:** `Run /forecast-narrative for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /forecast-narrative using our current CRM funnel and last 90 days of win/loss notes.`  
