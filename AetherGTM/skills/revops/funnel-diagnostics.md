...
## Task
Analyze funnel conversion bottlenecks. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /funnel-diagnostics for mid-market SaaS security buyers.`
