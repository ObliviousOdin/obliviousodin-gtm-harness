...
**Trigger:** `/funnel-diagnostics`  
**Domain:** revops  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Analyze funnel conversion bottlenecks.
...
## Examples
**Input:** `Run /funnel-diagnostics for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /funnel-diagnostics using our current CRM funnel and last 90 days of win/loss notes.`  
