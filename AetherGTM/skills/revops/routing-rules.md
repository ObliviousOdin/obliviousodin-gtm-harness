...
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Define lead, account, and opportunity routing rules.
...
## Task
Define lead, account, and opportunity routing rules.
...
## Examples
**Input:** `Run /routing-rules for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /routing-rules using our current CRM funnel and last 90 days of win/loss notes.`  
