...
## Task
Inspect pipeline quality and risk.
...
## Examples
**Input:** `Run /pipeline-inspector for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /pipeline-inspector using our current CRM funnel and last 90 days of win/loss notes.`  
