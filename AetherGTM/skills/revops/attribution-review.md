...
## Task
Review attribution approach and identify decision-safe reporting. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /attribution-review for enterprise fintech accounts in North America; output=hybrid.`
