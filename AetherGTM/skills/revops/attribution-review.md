...
**Trigger:** `/attribution-review`  
**Domain:** revops  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Review attribution approach and identify decision-safe reporting.
...
## Task
Review attribution approach and identify decision-safe reporting.
...
## Examples
**Input:** `Run /attribution-review for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /attribution-review using our current CRM funnel and last 90 days of win/loss notes.`  
