...
**Trigger:** `/sla-designer`  
**Domain:** revops  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create marketing-sales-CS SLAs with metrics and escalation paths.
...
## Task
Create marketing-sales-CS SLAs with metrics and escalation paths.
...
## Examples
**Input:** `Run /sla-designer for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /sla-designer using our current CRM funnel and last 90 days of win/loss notes.`  
