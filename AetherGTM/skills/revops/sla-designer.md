...
## Task
Create marketing-sales-CS SLAs with metrics and escalation paths. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /sla-designer for enterprise fintech accounts in North America; output=hybrid.`
