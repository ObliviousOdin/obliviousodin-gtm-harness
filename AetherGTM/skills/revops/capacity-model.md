...
## Task
Create a GTM capacity model for pipeline and revenue planning.
...
## Examples
**Input:** `Run /capacity-model for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /capacity-model using our current CRM funnel and last 90 days of win/loss notes.`  
