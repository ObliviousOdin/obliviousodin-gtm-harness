...
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Design a lead and account scoring model.
...
## Task
Design a lead and account scoring model.
...
## Examples
**Input:** `Run /lead-scoring for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /lead-scoring using our current CRM funnel and last 90 days of win/loss notes.`  
