...
## Task
Design a lead and account scoring model. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /lead-scoring for enterprise fintech accounts in North America; output=hybrid.`
