...
## Task
Analyze segment performance and recommend resource allocation. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /segment-performance for enterprise fintech accounts in North America; output=hybrid.`
