...
**Trigger:** `/board-metrics`  
**Domain:** analytics  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create board metrics pack.
...
## Examples
**Input:** `Run /board-metrics for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /board-metrics using our current CRM funnel and last 90 days of win/loss notes.`  
