...
## Task
Build GTM KPI tree. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /kpi-tree for mid-market SaaS security buyers.`
