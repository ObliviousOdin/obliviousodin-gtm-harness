...
## Examples
**Input:** `Run /kpi-tree for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /kpi-tree using our current CRM funnel and last 90 days of win/loss notes.`  
