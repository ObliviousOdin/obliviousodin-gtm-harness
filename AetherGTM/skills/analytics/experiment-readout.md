...
## Task
Create experiment readout with decision and next iteration. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /experiment-readout for enterprise fintech accounts in North America; output=hybrid.`
