...
**Trigger:** `/experiment-readout`  
**Domain:** analytics  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create experiment readout with decision and next iteration.
...
## Task
Create experiment readout with decision and next iteration.
...
## Examples
**Input:** `Run /experiment-readout for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /experiment-readout using our current CRM funnel and last 90 days of win/loss notes.`  
