...
## Task
Specify an executive GTM dashboard with metric definitions.
...
## Examples
**Input:** `Run /exec-dashboard-spec for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /exec-dashboard-spec using our current CRM funnel and last 90 days of win/loss notes.`  
