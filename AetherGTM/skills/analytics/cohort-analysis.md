...
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Design cohort analysis for acquisition, activation, retention, and expansion.
...
## Task
Design cohort analysis for acquisition, activation, retention, and expansion.
...
## Examples
**Input:** `Run /cohort-analysis for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /cohort-analysis using our current CRM funnel and last 90 days of win/loss notes.`  
