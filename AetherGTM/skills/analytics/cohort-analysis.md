...
## Task
Design cohort analysis for acquisition, activation, retention, and expansion. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /cohort-analysis for enterprise fintech accounts in North America; output=hybrid.`
