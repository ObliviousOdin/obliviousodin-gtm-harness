...
**Trigger:** `/decision-memo`  
**Domain:** core  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Turn GTM ambiguity into an executive decision memo with options and tradeoffs.
...
## Task
Turn GTM ambiguity into an executive decision memo with options and tradeoffs.
...
## Examples
**Input:** `Run /decision-memo for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /decision-memo using our current CRM funnel and last 90 days of win/loss notes.`  
