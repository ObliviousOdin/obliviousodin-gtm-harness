...
## Task
Turn GTM ambiguity into an executive decision memo with options and tradeoffs. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /decision-memo for enterprise fintech accounts in North America; output=hybrid.`
