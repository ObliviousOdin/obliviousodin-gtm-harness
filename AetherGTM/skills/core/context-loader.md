...
## Task
Load and summarize all relevant context files.
...
## Examples
**Input:** `Run /load-gtm-context for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /load-gtm-context using our current CRM funnel and last 90 days of win/loss notes.`  
