...
**Trigger:** `/north-star-metric`  
**Domain:** core  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Define a GTM north-star metric and supporting input metrics.
...
## Task
Define a GTM north-star metric and supporting input metrics.
...
## Examples
**Input:** `Run /north-star-metric for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /north-star-metric using our current CRM funnel and last 90 days of win/loss notes.`  
