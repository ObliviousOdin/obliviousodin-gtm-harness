...
**Trigger:** `/gtm-prioritize`  
**Domain:** core  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Prioritize initiatives by impact, confidence, effort, and risk.
...
## Task
Prioritize initiatives by impact, confidence, effort, and risk.
...
## Examples
**Input:** `Run /gtm-prioritize for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /gtm-prioritize using our current CRM funnel and last 90 days of win/loss notes.`  
