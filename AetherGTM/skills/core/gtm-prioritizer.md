...
## Task
Prioritize initiatives by impact, confidence, effort, and risk. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /gtm-prioritize for mid-market SaaS security buyers.`
