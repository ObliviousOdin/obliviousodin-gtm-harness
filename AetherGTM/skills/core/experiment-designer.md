...
## Task
Design GTM experiments with hypotheses and metrics. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /experiment-design for mid-market SaaS security buyers.`
