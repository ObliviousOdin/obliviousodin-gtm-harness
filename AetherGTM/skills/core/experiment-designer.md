...
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Design GTM experiments with hypotheses and metrics.
...
## Task
Design GTM experiments with hypotheses and metrics.
...
## Examples
**Input:** `Run /experiment-design for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /experiment-design using our current CRM funnel and last 90 days of win/loss notes.`  
