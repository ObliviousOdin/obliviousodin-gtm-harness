...
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Synthesize customer, market, sales, and product research into GTM insights.
...
## Task
Synthesize customer, market, sales, and product research into GTM insights.
...
## Examples
**Input:** `Run /research-synthesis for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /research-synthesis using our current CRM funnel and last 90 days of win/loss notes.`  
