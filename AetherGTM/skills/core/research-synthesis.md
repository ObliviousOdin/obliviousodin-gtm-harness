...
## Task
Synthesize customer, market, sales, and product research into GTM insights. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /research-synthesis for enterprise fintech accounts in North America; output=hybrid.`
