...
**Trigger:** `/assumption-ledger`  
**Domain:** core  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create and maintain a GTM assumptions, evidence, and validation ledger.
...
## Task
Create and maintain a GTM assumptions, evidence, and validation ledger.
...
## Examples
**Input:** `Run /assumption-ledger for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /assumption-ledger using our current CRM funnel and last 90 days of win/loss notes.`  
