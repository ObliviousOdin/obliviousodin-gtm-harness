...
## Task
Create and maintain a GTM assumptions, evidence, and validation ledger. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /assumption-ledger for enterprise fintech accounts in North America; output=hybrid.`
