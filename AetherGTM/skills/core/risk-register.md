...
**Trigger:** `/risk-register`  
**Domain:** core  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Build a GTM risk register with severity, likelihood, mitigations, and owners.
...
## Task
Build a GTM risk register with severity, likelihood, mitigations, and owners.
...
## Examples
**Input:** `Run /risk-register for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /risk-register using our current CRM funnel and last 90 days of win/loss notes.`  
