...
## Task
Build a GTM risk register with severity, likelihood, mitigations, and owners. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /risk-register for enterprise fintech accounts in North America; output=hybrid.`
