...
## Task
Audit the GTM system and identify gaps.
...
## Examples
**Input:** `Run /gtm-audit for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /gtm-audit using our current CRM funnel and last 90 days of win/loss notes.`  
