...
## Role
Act as a senior GTM operator and domain expert in core. Think like a strategist, practitioner, analyst, and enablement lead.

## Task
Design the GTM operating cadence, meetings, artifacts, and accountability loops. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /operating-cadence for enterprise fintech accounts in North America; output=hybrid.`
