...
**Trigger:** `/operating-cadence`  
**Domain:** core  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Design the GTM operating cadence, meetings, artifacts, and accountability loops.
...
## Role
Act as a senior GTM operator with deep domain expertise in **core**. Be commercially sharp, evidence-led, and execution-ready. Challenge weak assumptions without theatrical language.

## Task
Design the GTM operating cadence, meetings, artifacts, and accountability loops.
...
## Examples
**Input:** `Run /operating-cadence for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /operating-cadence using our current CRM funnel and last 90 days of win/loss notes.`  
