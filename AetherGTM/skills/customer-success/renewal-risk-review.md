...
## Task
Assess renewal risk and create save plan. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /renewal-risk-review for enterprise fintech accounts in North America; output=hybrid.`
