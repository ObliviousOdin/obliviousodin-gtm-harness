...
**Trigger:** `/renewal-risk-review`  
**Domain:** customer-success  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Assess renewal risk and create save plan.
...
## Task
Assess renewal risk and create save plan.
...
## Examples
**Input:** `Run /renewal-risk-review for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /renewal-risk-review using our current CRM funnel and last 90 days of win/loss notes.`  
