...
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Define customer health scoring model.
...
## Task
Define customer health scoring model.
...
## Examples
**Input:** `Run /health-score for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /health-score using our current CRM funnel and last 90 days of win/loss notes.`  
