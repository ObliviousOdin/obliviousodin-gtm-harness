...
## Task
Create adoption play by segment, use case, and behavior trigger. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /adoption-play for enterprise fintech accounts in North America; output=hybrid.`
