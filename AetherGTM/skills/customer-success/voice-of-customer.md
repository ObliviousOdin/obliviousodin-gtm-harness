...
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Synthesize VOC inputs into themes and GTM actions.
...
## Task
Synthesize VOC inputs into themes and GTM actions.
...
## Examples
**Input:** `Run /voice-of-customer for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /voice-of-customer using our current CRM funnel and last 90 days of win/loss notes.`  
