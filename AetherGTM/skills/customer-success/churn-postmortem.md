...
## Task
Run churn postmortem and identify prevention plays. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /churn-postmortem for enterprise fintech accounts in North America; output=hybrid.`
