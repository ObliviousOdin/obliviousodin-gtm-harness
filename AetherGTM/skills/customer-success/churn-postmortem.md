...
**Trigger:** `/churn-postmortem`  
**Domain:** customer-success  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Run churn postmortem and identify prevention plays.
...
## Task
Run churn postmortem and identify prevention plays.
...
## Examples
**Input:** `Run /churn-postmortem for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /churn-postmortem using our current CRM funnel and last 90 days of win/loss notes.`  
