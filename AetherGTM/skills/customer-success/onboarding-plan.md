...
## Task
Create customer onboarding plan with milestones, owners, and success criteria.
...
## Examples
**Input:** `Run /onboarding-plan for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /onboarding-plan using our current CRM funnel and last 90 days of win/loss notes.`  
