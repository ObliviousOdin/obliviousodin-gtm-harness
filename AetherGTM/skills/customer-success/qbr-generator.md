...
## Task
Generate executive QBR. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /qbr-generator for mid-market SaaS security buyers.`
