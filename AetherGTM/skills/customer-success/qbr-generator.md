...
**Trigger:** `/qbr-generator`  
**Domain:** customer-success  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Generate executive QBR.
...
## Examples
**Input:** `Run /qbr-generator for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /qbr-generator using our current CRM funnel and last 90 days of win/loss notes.`  
