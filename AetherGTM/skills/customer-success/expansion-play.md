...
## Task
Create expansion play. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /expansion-play for mid-market SaaS security buyers.`
