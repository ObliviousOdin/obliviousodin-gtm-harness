...
**Trigger:** `/expansion-play`  
**Domain:** customer-success  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create expansion play.
...
## Examples
**Input:** `Run /expansion-play for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /expansion-play using our current CRM funnel and last 90 days of win/loss notes.`  
