...
**Trigger:** `/pricing-diagnostic`  
**Domain:** pricing-packaging  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Diagnose pricing and packaging.
...
## Task
Diagnose pricing and packaging.
...
## Examples
**Input:** `Run /pricing-diagnostic for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /pricing-diagnostic using our current CRM funnel and last 90 days of win/loss notes.`  
