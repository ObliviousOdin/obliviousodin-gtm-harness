...
## Task
Design willingness-to-pay research and synthesis. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /willingness-to-pay for enterprise fintech accounts in North America; output=hybrid.`
