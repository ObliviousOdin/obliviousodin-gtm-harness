...
**Trigger:** `/packaging-options`  
**Domain:** pricing-packaging  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Generate packaging options.
...
## Examples
**Input:** `Run /packaging-options for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /packaging-options using our current CRM funnel and last 90 days of win/loss notes.`  
