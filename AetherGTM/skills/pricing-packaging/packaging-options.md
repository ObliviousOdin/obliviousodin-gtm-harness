...
## Task
Generate packaging options. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /packaging-options for mid-market SaaS security buyers.`
