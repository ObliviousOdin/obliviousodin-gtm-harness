...
**Trigger:** `/discount-governance`  
**Domain:** pricing-packaging  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create discount governance and approval rules.
...
## Task
Create discount governance and approval rules.
...
## Examples
**Input:** `Run /discount-governance for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /discount-governance using our current CRM funnel and last 90 days of win/loss notes.`  
