...
## Examples
**Input:** `Run /map-create for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /map-create using our current CRM funnel and last 90 days of win/loss notes.`  
