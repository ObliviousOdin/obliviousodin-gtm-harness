...
**Domain:** sales-sdr-ae  
**Version:** 0.1.0  
**Purpose:** Create mutual action plan.
...
## Task
Create mutual action plan. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /map-create for mid-market SaaS security buyers.`
