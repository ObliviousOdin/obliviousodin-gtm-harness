...
## Task
Create objection handling talk tracks. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /objection-handler for mid-market SaaS security buyers.`
