...
## Task
Assess an opportunity using MEDDIC/MEDDPICC criteria.
...
## Examples
**Input:** `Run /meddic-review for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /meddic-review using our current CRM funnel and last 90 days of win/loss notes.`  
