...
**Trigger:** `/meddic-review`  
**Domain:** sales-sdr-ae  
**Version:** 0.1.0  
**Purpose:** Assess an opportunity using MEDDIC/MEDDPICC criteria.
...
## Task
Assess an opportunity using MEDDIC/MEDDPICC criteria. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /meddic-review for enterprise fintech accounts in North America; output=hybrid.`
