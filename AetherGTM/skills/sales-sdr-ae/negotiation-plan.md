...
## Task
Create a negotiation plan with give-get logic and guardrails.
...
## Examples
**Input:** `Run /negotiation-plan for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /negotiation-plan using our current CRM funnel and last 90 days of win/loss notes.`  
