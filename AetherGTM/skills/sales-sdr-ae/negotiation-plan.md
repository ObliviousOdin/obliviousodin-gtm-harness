...
**Trigger:** `/negotiation-plan`  
**Domain:** sales-sdr-ae  
**Version:** 0.1.0  
**Purpose:** Create a negotiation plan with give-get logic and guardrails.
...
## Task
Create a negotiation plan with give-get logic and guardrails. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /negotiation-plan for enterprise fintech accounts in North America; output=hybrid.`
