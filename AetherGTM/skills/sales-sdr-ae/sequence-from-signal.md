...
## Task
Create outbound sequence from a buying signal.
...
## Examples
**Input:** `Run /sequence-from-signal for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /sequence-from-signal using our current CRM funnel and last 90 days of win/loss notes.`  
