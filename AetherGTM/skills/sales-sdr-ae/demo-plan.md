...
**Domain:** sales-sdr-ae  
**Version:** 0.1.0  
**Purpose:** Create a role-specific demo plan mapped to pain and proof.
...
## Task
Create a role-specific demo plan mapped to pain and proof. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /demo-plan for enterprise fintech accounts in North America; output=hybrid.`
