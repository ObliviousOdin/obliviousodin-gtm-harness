...
## Task
Create a role-specific demo plan mapped to pain and proof.
...
## Examples
**Input:** `Run /demo-plan for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /demo-plan using our current CRM funnel and last 90 days of win/loss notes.`  
