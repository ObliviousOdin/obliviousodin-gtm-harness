...
**Trigger:** `/account-plan`  
**Domain:** sales-sdr-ae  
**Version:** 0.1.0  
**Purpose:** Create an enterprise account plan with stakeholders, pains, and strategy.
...
## Task
Create an enterprise account plan with stakeholders, pains, and strategy. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /account-plan for enterprise fintech accounts in North America; output=hybrid.`
