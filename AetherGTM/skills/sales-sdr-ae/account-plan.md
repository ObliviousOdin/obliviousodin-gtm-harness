...
## Task
Create an enterprise account plan with stakeholders, pains, and strategy.
...
## Examples
**Input:** `Run /account-plan for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /account-plan using our current CRM funnel and last 90 days of win/loss notes.`  
