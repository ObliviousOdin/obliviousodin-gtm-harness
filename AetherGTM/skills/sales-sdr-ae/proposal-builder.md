...
**Trigger:** `/proposal-builder`  
**Domain:** sales-sdr-ae  
**Version:** 0.1.0  
**Purpose:** Build a proposal structure with business case, scope, pricing, and mutual commitments.
...
## Task
Build a proposal structure with business case, scope, pricing, and mutual commitments. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /proposal-builder for enterprise fintech accounts in North America; output=hybrid.`
