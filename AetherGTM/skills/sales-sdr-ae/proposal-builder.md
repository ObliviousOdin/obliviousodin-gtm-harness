...
## Task
Build a proposal structure with business case, scope, pricing, and mutual commitments.
...
## Examples
**Input:** `Run /proposal-builder for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /proposal-builder using our current CRM funnel and last 90 days of win/loss notes.`  
