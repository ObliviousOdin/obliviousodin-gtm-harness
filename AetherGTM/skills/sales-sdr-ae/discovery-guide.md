...
## Examples
**Input:** `Run /discovery-guide for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /discovery-guide using our current CRM funnel and last 90 days of win/loss notes.`  
