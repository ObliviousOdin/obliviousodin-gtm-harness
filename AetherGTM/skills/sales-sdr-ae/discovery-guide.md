...
**Trigger:** `/discovery-guide`  
**Domain:** sales-sdr-ae  
**Version:** 0.1.0  
**Purpose:** Create discovery call guide.
...
## Task
Create discovery call guide. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /discovery-guide for mid-market SaaS security buyers.`
