...
**Trigger:** `/sales-playbook`  
**Domain:** enablement  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create a sales playbook for a segment, product, or motion.
...
## Task
Create a sales playbook for a segment, product, or motion.
...
## Examples
**Input:** `Run /sales-playbook for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /sales-playbook using our current CRM funnel and last 90 days of win/loss notes.`  
