...
## Task
Build call coaching scorecard and manager guide. Transform user inputs into a production-ready GTM artifact that can be used by leadership and frontline teams.
...
## Examples
Input: `Run /call-coaching-scorecard for enterprise fintech accounts in North America; output=hybrid.`
