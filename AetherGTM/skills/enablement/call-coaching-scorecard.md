...
**Trigger:** `/call-coaching-scorecard`  
**Domain:** enablement  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Build call coaching scorecard and manager guide.
...
## Task
Build call coaching scorecard and manager guide.
...
## Examples
**Input:** `Run /call-coaching-scorecard for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /call-coaching-scorecard using our current CRM funnel and last 90 days of win/loss notes.`  
