...
**Trigger:** `/battlecard-builder`  
**Domain:** enablement  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Build competitive battlecard.
...
## Examples
**Input:** `Run /battlecard-builder for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /battlecard-builder using our current CRM funnel and last 90 days of win/loss notes.`  
