...
## Task
Build competitive battlecard. Convert messy user inputs into a decision-ready artifact with clear assumptions, risks, and next actions.
...
## Examples
Input: `Run /battlecard-builder for mid-market SaaS security buyers.`
