...
## Task
Create enablement rollout plan.
...
## Examples
**Input:** `Run /enablement-plan for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /enablement-plan using our current CRM funnel and last 90 days of win/loss notes.`  
