...
**Trigger:** `/certification-path`  
**Domain:** enablement  
**Version:** 1.0.0  
**Status:** production  
**Purpose:** Create role-based enablement certification path.
...
## Task
Create role-based enablement certification path.
...
## Examples
**Input:** `Run /certification-path for mid-market B2B SaaS targeting security buyers in North America.`  
...
**Input:** `Run /certification-path using our current CRM funnel and last 90 days of win/loss notes.`  
